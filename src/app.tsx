      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className="h-16 bg-zinc-900 p-4 rounded-xl flex items-center shadow-shape gap-3">
          ...
          <div className="flex items-center gap-2 flex-1">
            ...
            <input type="text" placeholder="Para onde você vai?" className="bg-transparent text-lg text-zinc-100 placeholder-zinc-400 outline-none flex-1" />
          </div>

          <div className="flex items-center gap-2">
            <Calendar className="size-5 text-zinc-400" />
            <input type="text" placeholder="Quando?" className="bg-transparent text-lg text-zinc-100 placeholder-zinc-400 w-40 outline-none" />
          </div>
